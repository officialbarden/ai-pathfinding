...
scoreboard players operation new astar.g = cur astar.g
scoreboard players add new astar.g 10
execute at d385fd95-56dd-45b0-bbc9-6a258183f0b5 if predicate astar:diagonal run scoreboard players add new astar.g 4
