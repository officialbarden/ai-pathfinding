...
execute as @s[scores={ai.Mode=2}, tag=ai.ChasingTargetEntity] store result score @s ai.PathfindingDuration run return run random value 2..5
execute store result score @s ai.PathfindingDuration run random value 100..120
