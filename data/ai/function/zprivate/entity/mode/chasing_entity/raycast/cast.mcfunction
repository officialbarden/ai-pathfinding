...
# // Visible Beam
#execute if data storage test {can_see:0} run particle electric_spark ~ ~ ~ 0 0 0 0 1 force
#execute if data storage test {can_see:1} run particle ash ~ ~ ~ 0 0 0 0 1 force
